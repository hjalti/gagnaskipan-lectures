...
\begin{frame}{Helstu atriði}
    \begin{itemize}
        \item Mikið stökk úr Forritun
        \item Mörg verkefni
        \item Verkefni skarast
        \item Opnir dæmatímar
    \end{itemize}
\end{frame}
...
\begin{frame}{Skörun}
    \begin{itemize}
        \item 7 bestu dæmatímaverkefnin af 11 gilda
        \item Aðeins þarf að gera eitt dæmatímaverkefni samhliða skilaverkefni
    \end{itemize}
\end{frame}

\begin{frame}{Opnir dæmatímar}
    \begin{itemize}
        \item Athugasemdum hefur verið komið áleiðis til forstöðumanns grunnnáms
    \end{itemize}
\end{frame}
