...
\begin{frame}{Gildissvið}
    \begin{itemize}
        \item Þumalputtaregla: Slaufusvigar skilgreina gildissvið
        \item Breyta sem skilgreind er inni í gildissviði lifir bara þar
        \item Þegar keyrsla forrits fer út úr gildissviði skilar C++ því minni sem tekið var frá fyrir það gildissvið
            \begin{itemize}
                \item Sjáum nánar þegar við tölum um klasa
            \end{itemize}
        \item Hægt er að skyggja á (e. shadow) breytur
    \end{itemize}
\end{frame}
